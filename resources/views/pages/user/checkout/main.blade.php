<x-User-Layout title="Cart">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="col-md-12 form-group p_star">
                                <input type="hidden" class="form-control" id="biayaongkir" name="biayaongkir"
                                    value="">
                            </div>
                            <div class="col-md-12 form-group p_star">
                            ...
                            <div class="col-md-12 form-group p_star">
                                ...
                                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap"
                                    placeholder="Nama Penerima" value="{{ Auth::user()->nama_lengkap }}">
                            </div>
                            <div class="col-md-12 form-group p_star">
                                <label>Nomor Telepon</label>
                                <input type="text" class="form-control" id="notelp" name="notelp"
                                    placeholder="No HP" value="{{ Auth::user()->notelp }}">
                            </div>
                            <div class="col-md-12 form-group p_star">
                                <label>Alamat</label>
                                <input type="text" class="form-control" id="alamat" name="alamat"
                                    placeholder="Alamat Rumah" value="{{ Auth::user()->alamat }}">
                            </div>
                                ...
                                <div class="controls">
                                    <select name="provinsi" id="provinsi" class="form-control">
                                        ...
                                        @for ($i = 0; $i < count($get['rajaongkir']['results']); $i++)
                                            <option value="{{ $get['rajaongkir']['results'][$i]['province_id'] }}">
                                                {{ $get['rajaongkir']['results'][$i]['province'] }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 form-group p_star">
                                <div class="text-center">
                                    <button type="submit" class="button button-paypal"
                                        style="font-size: 16px; margin-top: 30px;">Buat Pesanan</button>
                                </div>
                            </div>
                            ...
                            <div class="order_box">
                                ...
                                <ul class="list" style="line-height: 0px;">
                                    ...
                                    @php
                                        $subtotal = 0;
                                    @endphp
                                    @foreach ($carts as $i => $cart_items)
                                        @php
                                            $subtotal += $cart_items->qty * $cart_items->produk->harga;
                                        @endphp
                                        <li>
                                            <div class="col-md-12 form-group p_star">
                                                <input type="hidden" class="form-control" id="product_name"
                                                    name="product_name" value="{{ $cart_items->produk->nama }}">
                                            </div>
                                            <a href="#">{{ $cart_items->produk->nama }}
                                                <span class="last" style="margin-left: 20px;">x
                                                    {{ $cart_items->qty }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                                <ul class="list list_2" style="line-height: 0px;">
                                    <li><a href="#" id="subtotal" name="subtotal" value="">Sub Total
                                            <span>Rp
                                                {{ number_format($subtotal) }}
                                            </span></a></li>
                                    <input type="hidden" name="subtotal_inp" id="subtotal_inp"
                                        value="{{ $subtotal }}">
                                    <li><a href="#" id="ongkir" name="ongkir" value="">Biaya
                                            Pengiriman <span>Rp </span>
                                        </a></li>
                                    <li><a href="#" id="total" name="total" value="">Total
                                            <span></span></a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <footer class="main-footer">
        <div class="footer-left">
            Copyright © 2022 <div class="bullet"></div> Develop By <a href="#">Kelompok 15
                TA</a>
        </div>
